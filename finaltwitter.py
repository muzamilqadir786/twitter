...
#       Instructions
#       Install tweepy and gdata module using pip install tweepy, pip install gdata
#       The script will stream all the keywords and writes them to csv(Excel file), the tweet text and User
#       usage: python ./twitter.py [stream or search] keywords(Comma Separated Strings) \n Exp: python twitter.py stream "patent assertion,patent freedom"
#       Enter username and password on line 43,44
##############################
